...
function HomePage() {
  ...
  const { ref, inView } = useInView({
    // Chỉ kích hoạt một lần khi vào vùng nhìn thấy
    threshold: 0.5, // Tỉ lệ phần tử cần vào vùng nhìn thấy để kích hoạt
  });
  useEffect(() => {
    (async () => {
      setLoading(true);
      ...
      <section id="hero">
        <div className="relative">
          <video
            ...
            src="https://d8um25gjecm9v.cloudfront.net/Vinamilk_Landscape_Hi-res.mp4"
            autoPlay
            muted
            loop
            playsInline
          ...
          <div className="container py-[124px] md:py-[80px]">
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-1/4 md:w-1/2 flex flex-col px-6 md:px-4 md:pt-4 text-primary text-center">
                ...
                <p className="font-lora leading-[20px]">
                  Trẻ em được nuôi dưỡng bằng cả tấm lòng
                </p>
              </div>
              <div className="w-1/4 md:w-1/2 flex flex-col px-6 md:px-4 md:pt-4 text-primary text-center">
                <div
